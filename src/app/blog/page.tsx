          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 mt-16">
            <Link href="/blog/next">
              <div className="bg-white shadow-lg rounded-lg overflow-hidden">
                ...
                <div className="p-4">
                  <h3 className="text-xl sm:text-2xl font-extrabold uppercase">Next.js</h3>
            ...
            <Link href="/blog/python">
              <div className="bg-white shadow-lg rounded-lg overflow-hidden">
                ...
                <div className="p-4">
                  <h3 className="text-xl sm:text-2xl font-extrabold uppercase">Python</h3>
            ...
            <Link href="/blog/AI">
              <div className="bg-white shadow-lg rounded-lg overflow-hidden">
                ...
                <div className="p-4">
                  <h3 className="text-xl sm:text-2xl font-extrabold uppercase">Artificial Intelligence</h3>
        ...
        <section className="py-12 px-6 bg-black">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 mt-16">
            <div className="bg-white shadow-md rounded-lg overflow-hidden">
              ...
              <div className="p-4">
                <h3 className="text-xl sm:text-2xl font-extrabold uppercase">HTML</h3>
            ...
            <div className="bg-white shadow-md rounded-lg overflow-hidden">
              ...
              <div className="p-4">
                <h3 className="text-xl sm:text-2xl font-extrabold uppercase">CSS</h3>
            ...
            <div className="bg-white shadow-md rounded-lg overflow-hidden">
              ...
              <div className="p-4">
                <h3 className="text-xl sm:text-2xl font-extrabold uppercase">JavaScript</h3>
